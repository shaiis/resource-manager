 ...
 * @param retry - if set to false then no retry on next invocation
 * @constructor
 */
 ...
 * if retry is true. Calling the function after reource is ready return the cached resource as fulfilled promise
